...
alias cor='cd ~/startups/corvus'
alias ava='cd ~/startups/voiya-work/avaza-os'
alias vri='cd ~/startups/voiya-work/avaza-vri'
alias vag='cd ~/startups/voiya-work/voiya-agents'
