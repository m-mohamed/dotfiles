...
Code examples reference actual files: `dot-zshenv/dot-zshenv:17` means line 17 in that file.
...
```bash
# File: dot-zshenv/dot-zshenv:4-8
...
**Reference:** `dot-zshenv/dot-zshenv:17`
